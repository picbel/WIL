...
## 목차
- [2일](#2일)
  - [MySql의 User-Level-Lock (Named Lock)](#mysql의-user-level-lock-named-lock)
- [4일](#4일)
  - [2PC (Two-Phase Commit)](#2pc-two-phase-commit)
- [5일](#5일)
  - [블룸 필터(Bloom Filter)](#블룸-필터bloom-filter)
- [6일](#6일)
  - [아웃박스 패턴 (Outbox Pattern)](#아웃박스-패턴-outbox-pattern)
- [22일](#22일)
  - [WAL : 로그 기반 복구(Write-Ahead Logging)](#wal--로그-기반-복구write-ahead-logging)
- [28일](#28일)
