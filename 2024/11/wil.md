...
## 목차
- [8일](#8일)
  - [Spring Data Redis의 Transaction 설정](#spring-data-redis의-transaction-설정)
- [12일](#12일)
  - [TCP Head-of-Line (HOL) Blocking 문제](#tcp-head-of-line-hol-blocking-문제)
- [19일](#19일)
  - [HikariCP 커넥션 시간 설정과 MySQL의 커넥션 타임아웃 설정](#hikaricp-커넥션-시간-설정과-mysql의-커넥션-타임아웃-설정)
- [22일](#22일)
  - [클러스터 인덱스, 비클러스터형 인덱스](#클러스터-인덱스-비클러스터형-인덱스)
- [30일](#30일)
  - [Java의 I/O와 NIO(Non-blocking I/O)](#java의-io와-nionon-blocking-io)
